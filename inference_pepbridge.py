...
if __name__ == '__main__':
    ...
    args.add_argument('--ckpt', type=str, default=f'{DATA_DIR}/logs/learn_surf_angle[1]_2025_07_11__11_50_08_tranlossx0_rotloss_time1000_batch7_block7_withsurf00loss01lr2e5/checkpoints/4080000.pt')
    args.add_argument('--tag', type=str, default='tranlossx0_rotloss_4080k_t01_vemat_nosurfcenter')
